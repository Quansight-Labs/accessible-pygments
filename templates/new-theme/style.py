...
# Default colors for the theme - update to match your theme
class Colors:
    comment = "#d4d0ab"
    red = "#ffa07a"
    orange = "#f5ab35"
...
class Theme(Style):
    """Class defining the theme's colors

    Args:
        Style (pygments.style): Style object from the pygments library
    """

    default_style = ""

    # Update these colours to match your theme
